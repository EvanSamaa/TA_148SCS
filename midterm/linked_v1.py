...
class LinkedList:
    ...
    def change_last(self, v: int) -> Optional[int]:
        ...
        []
        """
        if self._first is None: # TODO: Replace False with appropriate if-condition
            return None
        else:
            curr = self._first
            while not curr.next is None:  # TODO: Replace False with appropriate while-condition
                curr = curr.next
